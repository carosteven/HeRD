...
Usage:
    python3 benchmark/rrt/eval_with_sampling_planner.py --num_eps 10 --config small_columns
    python3 benchmark/rrt/eval_with_sampling_planner.py --num_eps 50 --config large_divider --verbose
"""
